...
<script>
  ...
  export default {
    mounted() {
      ...
      recaptchaScript.setAttribute('src', 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/gsap-latest-beta.min.js')
      document.head.appendChild(recaptchaScript)
      let anotherScript = document.createElement('script')
      anotherScript.setAttribute('src', 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/CSSRulePlugin3.min.js')
